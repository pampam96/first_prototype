...
with open('10_16_14_35_44.txt','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
    for i,row in enumerate(plots):
        d1.append(int(float(row[0])))
        d2.append(int(float(row[1])))
        a2.append(int(float(row[2])))
        a1.append(int(float(row[3])))
        index.append(i)
        
with open('10_16_15_13_42.txt','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
    for i,row in enumerate(plots):
        d1_1.append(int(float(row[0])))
        d2_1.append(int(float(row[1])))
        a2_1.append(int(float(row[2])))
        a1_1.append(int(float(row[3])))
        index.append(i)
