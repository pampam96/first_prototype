...
with open('csrt_10_23_14_05_41.txt','r') as csvfile:
...
with open('csrt_10_23_14_48_16.txt','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
    for i,row in enumerate(plots):
...
plt.title('CSRT Tests Side motor')
plt.legend()
plt.show()
...
plt.xlabel('Real Value in mm')
plt.ylabel('Distance in mm')
plt.title('CSRT Tests Middle motor')
plt.legend()
plt.show()