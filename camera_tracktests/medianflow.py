...
with open('medianflow_10_23_15_11_21.txt','r') as csvfile:
...
with open('medianflow_10_23_16_45_30.txt','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
    for i,row in enumerate(plots):
...
plt.title('Median Flow Tests Side motor')
plt.legend()
plt.show()
...
plt.xlabel('Real Value in mm')
plt.ylabel('Distance in mm')
plt.title('Median Flow Tests Middle motor')
plt.legend()
plt.show()
